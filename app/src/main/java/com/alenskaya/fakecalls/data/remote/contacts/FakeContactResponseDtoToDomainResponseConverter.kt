...
import com.alenskaya.fakecalls.data.remote.Converter
 ...
 */
class FakeContactResponseDtoToDomainResponseConverter : Converter<FakeContactResponseDto, FakeContactsResponse> {
